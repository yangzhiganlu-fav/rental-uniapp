    ...
    >
        ...
        <view v-if="state.data && !state.loading">
                    ...
                    <template #groupon>
                        <view class="ss-flex">
                            <view class="sales-title"
                                >{{ state.data.headRecord.userSize }}人团</view
                            >
                            <view class="num-title ss-m-l-20"
                                >已拼{{ state.data.headRecord.userCount }}件</view
                            >
                        </view>
                    </template>
                </s-goods-item>
            ...
            <view class="countdown-box detail-card ss-p-t-44 ss-flex-col ss-col-center">
                ...
                <view v-if="state.data.headRecord.status === 0">
                    ...
                    <view class="countdown-title ss-flex" v-else>
                        ...
                        <view class="num"
                            >{{
                                state.data.headRecord.userSize - state.data.headRecord.userCount
                            }}人</view
                        >
                        拼团成功
            ...
            >
                ...
                <button class="ss-reset-button join-btn" v-else @tap="onCreateGroupon">
                    我要开团
                </button>
            </view>
