                    ...
                    >
                        ...
                        <template #activity>
                            <view class="limit">
                                限量
                                <text class="ss-m-l-5"
                                    >{{ activity.stock }} {{ activity.unitName }}</text
                                >
                            </view>
                            <su-progress
                        ...
                        <template #cart>
                            ...
                            <button
                                ...
                                @click="
                                    sheep.$router.go('/pages/goods/seckill', { id: activity.id })
                                "
...
<script setup>
    ...
    const pageHeight =
        (safeArea.height + safeAreaInsets.bottom) * 2 +
        statusBarHeight -
        sheep.$platform.navbar -
        350;
