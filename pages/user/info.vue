    ...
    <s-layout title="用户信息" class="set-userinfo-wrap">
            ...
            <view class="account-list ss-flex ss-row-between">
                ...
                >
                    <image
                        class="list-img"
                        :src="
                            sheep.$url.static('/static/img/shop/platform/WechatOfficialAccount.png')
                        "
                    />
                ...
                <view class="ss-flex ss-col-center">
                    ...
                    <view class="bind-box ss-m-l-20">
                        ...
                        <button v-else class="ss-reset-button bind-btn" @tap="bindThirdOauth"
                            >绑定</button
                        >
                    </view>
                </view>
        ...
        <su-fixed bottom placeholder bg="none">
            <view class="footer-box ss-p-20">
                <button class="ss-rest-button logout-btn ui-Shadow-Main" @tap="onSubmit"
                    >保存</button
                >
            </view>
        </su-fixed>
