        ...
        <view class="bg-white total-card-box ss-p-20 ss-m-b-14 ss-r-10">
            <view class="total-box-content border-bottom">
                    ...
                    <view class="ss-flex ss-col-center">
                        ...
                        >
                            <checkbox
                                ...
                                :disabled="
                                    !state.orderInfo.totalPoint || state.orderInfo.totalPoint <= 0
                                "
                            />
                        </checkbox-group>
                    </view>
                ...
                >
                    ...
                    <view class="ss-flex ss-col-center">
                        <text
                            class="item-value ss-m-r-24"
                            v-if="state.orderInfo.price.deliveryPrice > 0"
                        >
                ...
                >
                    ...
                    <view class="ss-flex ss-col-center" @tap="state.showCoupon = true">
                        ...
                        >
                            {{
                                state.couponInfo.filter((coupon) => coupon.match).length > 0
                                    ? state.couponInfo.filter((coupon) => coupon.match).length +
                                      ' 张可用'
                                    : '暂无可用优惠券'
                            }}
                        </text>
            ...
            <view class="total-box-footer ss-font-28 ss-flex ss-row-right ss-col-center ss-m-r-28">
                ...
                <view class="total-num text-red">
                    ￥{{ fen2yuan(state.orderInfo.price.payPrice) }}</view
                >
            </view>
        </view>
...
<script setup>
    ...
    function onConfirm() {
        ...
        if (addressState.value.deliveryType === 2) {
            ...
            if (
                addressState.value.receiverName === '' ||
                addressState.value.receiverMobile === ''
            ) {
