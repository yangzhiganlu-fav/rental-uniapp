            ...
            <view class="content-box calendar">
                <view class="sign-everyday ss-flex ss-col-center ss-row-between ss-p-x-30">
                    ...
                    <view class="sign-num-box">
                        已连续签到
                        <text class="sign-num">{{ state.signInfo.continuousDay }}</text> 天
                    </view>
                </view>
                <view
                ...
                >
                    <view class="item" v-for="(item, index) in state.signConfigList" :key="index">
                        ...
                        <view
                            class="num"
                            :class="state.signInfo.continuousDay >= item.day ? 'on' : ''"
                        >
                            + {{ item.point }}
                        </view>
                    </view>
                ...
                <view class="myDateTable">
                    <view class="ss-flex ss-col-center ss-row-center sign-box ss-m-y-40">
                        ...
                        <button class="ss-reset-button already-btn" v-else disabled>
                            已签到
                        </button>
                    </view>
                </view>
            ...
            <view class="model-box ss-flex-col">
                <view class="ss-m-t-56 ss-flex-col ss-col-center">
                    ...
                    <view class="score-title">
                        <text v-if="state.signResult.point"
                            >{{ state.signResult.point }} 积分
                        </text>
                        <text v-if="state.signResult.experience">
                            {{ state.signResult.experience }} 经验</text
                        >
                    </view>
