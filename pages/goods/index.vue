            ...
            <block v-else>
                <view class="detail-swiper-selector">
                    ...
                    <view
                        ...
                        v-if="
                            state.settlementSku &&
                            state.settlementSku.id &&
                            state.settlementSku.promotionPrice
                        "
                    >
                        <image
                            class="disImg"
                            :src="sheep.$url.static('/static/img/shop/goods/dis.png')"
                        />
                        <view class="discountCont">
                            <view class="disContT">
                                ...
                                <view
                                    class="disContT2"
                                    v-if="state.settlementSku.promotionType === 4"
                                >
                                    限时折扣
                                </view>
                                <view
                                    class="disContT2"
                                    v-else-if="state.settlementSku.promotionType === 6"
                                >
                                    会员折扣
                                </view>
                            </view>
                            <view class="disContB">
                                ...
                                <view
                                    class="disContB2"
                                    v-if="state.settlementSku.promotionEndTime > 0"
                                >
                                    距结束仅剩
                                    <s-count-down
                                        :tipText="' '"
                            ...
                            >
                                [劵]满{{ fen2yuanSimple(coupon.usePrice) }}元{{
                                    coupon.discountType === 1
                                        ...
                                        : '打' +
                                          formatDiscountPercent(coupon.discountPercent) +
                                          '折'
                                }}
                            </view>
                            <!-- 查看满减送的描述 -->
