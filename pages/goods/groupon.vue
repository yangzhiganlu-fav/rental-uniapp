                                    ...
                                    <view class="tig-icon ss-flex ss-col-center ss-row-center">
                                        <view class="groupon-tag">
                                            <image
                                                :src="
                                                    sheep.$url.static(
                                                        '/static/img/shop/goods/groupon-tag.png',
                                                    )
                                                "
                                            ></image>
                                        </view>
            ...
            <detail-tabbar v-model="state.goodsInfo">
                <view class="buy-box ss-flex ss-col-center ss-p-r-20">
                    ...
                    >
                        ...
                        <view v-else-if="state.activity.endTime <= new Date().getTime()"
                            >已结束</view
                        >
                        <view v-else>
...
<script setup>
    ...
    onLoad(async (options) => {
        ...
        // 加载活动信息
        const { code, data: activity } = await CombinationApi.getCombinationActivity(
            state.grouponId,
        );
        if (code !== 0) {
            state.goodsInfo = null;
