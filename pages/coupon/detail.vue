            ...
            <view class="detail-wrap ss-p-20">
                <view class="detail-box">
                    ...
                    <view class="top ss-flex-col ss-col-center">
                        <view class="title ss-m-t-50 ss-m-b-20 ss-m-x-20">{{
                            state.coupon.name
                        }}</view>
                        ...
                        <view class="time ss-m-y-30" v-else>
                            有效期:
                            {{
                                sheep.$helper.timeFormat(state.coupon.validStartTime, 'yyyy-mm-dd')
                            }}
                            至
...
<script setup>
    ...
    async function getGoodsListById() {
        const { data, code } = await SpuApi.getSpuListByIds(
