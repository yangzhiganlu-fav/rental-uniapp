    ...
    <view class="ss-goods-wrap">
        ...
        >
            <view v-if="tagStyle.show" class="tag-icon-box">
                <image
                    class="tag-icon"
                    :src="sheep.$url.cdn(tagStyle.src || tagStyle.imgUrl)"
                ></image>
            </view>
            <image
                class="xs-img-box"
            ...
            >
                ...
                >
                    ...
                    <view
                        ...
                        v-if="
                            data.activityType &&
                            data.activityType === PromotionActivityTypeEnum.POINT.type
                        "
                    >
                        <image
                    ...
                    <template v-else>
                        ...
                        <text v-if="data.promotionPrice > 0">{{
        ...
        >
            ...
            <view class="lg-goods-content ss-flex-1 ss-flex-col ss-row-between ss-p-b-10 ss-p-t-20">
                ...
                <view>
                    ...
                    <view
                        v-if="goodsFields.price?.show"
                        class="ss-flex ss-col-bottom font-OPPOSANS"
                    >
                        <view
                        ...
                        <view
                            v-if="
                                (goodsFields.original_price?.show ||
                                    goodsFields.marketPrice?.show) &&
                                (data.original_price > 0 || data.marketPrice > 0)
                            "
                            class="goods-origin-price ss-m-t-16 font-OPPOSANS ss-flex"
                            :style="[{ color: originPriceColor }]"
