<template>
    <up-popup :show="showPopup" mode="bottom" round="10" @close="close">
        <view class="ss-bg-white ss-p-30">
            <!-- 顶部工具栏 -->
            <view class="ss-flex ss-row-between ss-items-center ss-m-b-30">
                <text class="ss-color-gray" @click="close">取消</text>
                <text class="ss-font-bold ss-font-32">{{ title }}</text>
            ...
            <scroll-view scroll-y style="max-height: 600rpx">
                ...
                >
                    <view
                        ...
                        :key="index"
                        class="ss-flex ss-row-between ss-items-center ss-p-y-20 ss-border-bottom"
