        ...
        <view class="model-box">
            ...
            <view v-if="state.rewardActivity && state.rewardActivity.id > 0">
                ...
                >
                    <view
                        class="actBox"
                        v-for="(item, index) in getRewardActivityRuleGroupDescriptions(
                    ...
                    >
                        ...
                        >
                            <view class="model-content-tag ss-flex ss-row-center">{{
                                item.name
                            }}</view>
                            <view class="model-content-title">
                                ...
                                <view class="ss-m-b-24 cotBu-txt">
                                    {{
                                        sheep.$helper.timeFormat(
                                            state.rewardActivity.startTime,
                                            'yyyy.mm.dd',
                                        )
                                    }}
                                    -
