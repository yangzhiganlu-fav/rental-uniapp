                    ...
                    <view class="header-right-bottom ss-flex ss-col-center ss-row-between">
                        <view class="ss-flex">
                            <view class="price-text">
                                {{
                                    fen2yuan(
                                        state.selectedSku.promotionPrice ||
                                            state.selectedSku.price ||
                                            goodsInfo.price,
                                    )
                                }}
                                <text v-if="state.selectedSku.promotionType > 0">
                                    <text
                                        class="iconBox"
                                        v-if="state.selectedSku.promotionType === 4"
                                    >
                                        限时优惠
                                    </text>
                                    <text
                                        class="iconBox"
                                        v-else-if="state.selectedSku.promotionType === 6"
                                    >
                                        会员价
                                    </text>
...
<script setup>
    ...
    function changeDisabled(isChecked = false, propertyId = 0, valueId = 0) {
        ...
        if (isChecked) {
            ...
            Object.entries(state.currentPropertyArray).forEach(
