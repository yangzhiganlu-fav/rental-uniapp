        ...
        <block v-if="scroll">
            <view class="ui-tab-scroll-warp">
                <scroll-view
                    ...
                    class="ui-tab-scroll"
                    :scroll-left="
                        state.curValue > 1 ? state.tabNodeList[state.curValue - 1].left : 0
                    "
                ...
                >
                    <view class="ss-flex ss-col-center">
                        ...
                        <view
                            ...
                            :style="[
                                { left: state.markLeft + 'px' },
                                { width: state.markWidth + 'px' },
                            ]"
                        >
                            <view
                                class="ui-tab-mark"
                                :class="[
                                    props.mark,
                                    { 'ui-btn': props.tpl == 'btn' || props.tpl == 'subtitle' },
                                ]"
                                :style="[
                                    {
                                        background:
                                            props.tpl == 'btn' || props.tpl == 'subtitle'
                                                ? titleStyle.activeBg
                                                : 'none',
                                    },
                                ]"
